...
namespace ZR.Model.Business
{
    ...
    public class WoBase
    {
        ...
        /// WorkOrder 
        /// </summary>
        [SugarColumn(IsPrimaryKey = true, IsIdentity = false, ColumnName = "wORK_ORDER")]
        ...
        /// 基本计量单位 
        /// </summary>
        [SugarColumn(ColumnName = "BASE_UNIT_MEASURE")]
        ...
        /// 设计卡 
        /// </summary>
        [SugarColumn(ColumnName = "DRAWNUM")]
        ...
        /// FixedLength 
        /// </summary>
        [SugarColumn(ColumnName = "FIXED_LENGTH")]
        public long FixedLength{ get; set; }

        /// <summary>
        /// DiskNumber 
        /// </summary>
        [SugarColumn(ColumnName = "DISK_NUMBER")]
        ...
        /// 包材 
        /// </summary>
        [SugarColumn(ColumnName = "PACKAGING_MATERIALS")]
        public string PackingMaterials { get; set; }

        /// <summary>
        /// 设计卡版本 
        /// </summary>
        [SugarColumn(ColumnName = "DRAWNUM_VERSION")]
        ...
        /// <summary>
        /// CustomerPartCustomerName 
        /// </summary>
        [SugarColumn(ColumnName = "CUSTOMERPART_CUSTOMERNAME")]
        public string CustomerPartCustomerName { get; set; }

        /// <summary>
        /// SalesOrderRow 
        /// </summary>
        [SugarColumn(ColumnName = "SALES_ORDER_ROW")]
        public string SalesOrderRow { get; set; }

        /// <summary>
        /// 定长单位 
        /// </summary>
        [SugarColumn(ColumnName = "FIXED_UNIT")]
        public string FixedUnit { get; set; }

        /// <summary>
        /// BomVer 
        /// </summary>
        [SugarColumn(ColumnName = "BOM_VER")]
        public string BomVer { get; set; }

        /// <summary>
        /// SoText 
        /// </summary>
        [SugarColumn(ColumnName = "SO_TEXT")]
        public string SoText { get; set; }

        /// <summary>
        /// SendAddress 
        /// </summary>
        [SugarColumn(ColumnName = "SEND_ADDRESS")]
        public string SendAddress { get; set; }

        /// <summary>
        /// TopWorkOrder 
        /// </summary>
        [SugarColumn(ColumnName = "TOP_WORK_ORDER")]
        public string TopWorkOrder { get; set; }

        /// <summary>
        /// WorkOrderExt 
        /// </summary>
        [SugarColumn(ColumnName = "WORK_ORDER_EXT")]
        public string WorkOrderExt { get; set; }

        /// <summary>
        /// Cuspart 
        /// </summary>
        [SugarColumn(ColumnName = "CUSPART")]
        public string Cuspart { get; set; }

        /// <summary>
        /// Uebto 
        /// </summary>
        [SugarColumn(ColumnName = "UEBTO")]
        public string Uebto { get; set; }

        /// <summary>
        /// LongText 
        /// </summary>
        [SugarColumn(ColumnName = "LONGTEXT")]
        ...
        /// </summary>
        [SugarColumn(ColumnName = "IDENTIFICATION_NUMBER")]
