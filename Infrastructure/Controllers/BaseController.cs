...
namespace Infrastructure.Controllers
{
    ...
    /// web层通用数据处理
    /// </summary>
    public class BaseController_old : ControllerBase
    {
        ...
        protected IActionResult MsgData(string msg, object data, string timeFormatStr = "yyyy-MM-dd HH:mm:ss")
        {
            string jsonStr = GetJsonStr(GetApiResult(data != null ? ResultCode.SUCCESS : ResultCode.NO_DATA, msg, data), timeFormatStr);
            return Content(jsonStr, "application/json");
        }
