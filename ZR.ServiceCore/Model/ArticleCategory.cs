...
namespace ZR.Model.System
{
    ...
    /// 文章目录
    /// </summary>
    [SugarTable("SAJET.m_zr_articleCategory", "文章目录")]
    [Tenant("0")]
    public class ArticleCategory
    {
        ...
        /// 目录id
        /// </summary>
        [SugarColumn(IsPrimaryKey = true/*, IsIdentity = true*/, ColumnName = "category_id", OracleSequenceName = "SAJET.zr_articleCategory_id")]
